<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Manager.Master" AutoEventWireup="true" CodeBehind="DeleteProduct.aspx.cs" Inherits="ShopLapTop.Admin.ManagerProduct.Function.DeleteProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="wapper">
        <h1 style="color: #D94A8C;">Xóa Sản Phẩm</h1>
        <div class="container">
            <div class="group">
            ...
            <br />
            <div>
                <asp:Button ID="btnDeleteProduct" runat="server" CssClass="btnsave" Text="Xóa sản phẩm" OnClientClick="return confirm('Bạn có muốn xóa Sản Phẩm này không?')" OnClick="btnDeleteProduct_Click" />
