...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <asp:Button ID="btnAddCategory" CssClass="btnAdd" runat="server" Text="Thêm" OnClick="btnAddCategory_Click" />
        <asp:Repeater ID="rptCategoriesList" OnItemDataBound="rptCategoriesList_ItemDataBound" runat="server">
            <HeaderTemplate>
        ...
        <asp:Repeater ID="RepeaterPagination" runat="server">
            <ItemTemplate>
                <a href="HomeCategories.aspx?categories=<%# Request.QueryString["product"] %>&page=<%# Container.DataItem %>"
