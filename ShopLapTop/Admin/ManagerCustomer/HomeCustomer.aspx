...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <asp:Repeater ID="rptCustomerList" OnItemDataBound="rptCustomerList_ItemDataBound" runat="server">
            <HeaderTemplate>
        ...
        <asp:Repeater ID="RepeaterPagination" runat="server">
            <ItemTemplate>
                <a href="HomeCustomer.aspx?product=<%# txtSearch.Text %>&page=<%# Container.DataItem %>"
